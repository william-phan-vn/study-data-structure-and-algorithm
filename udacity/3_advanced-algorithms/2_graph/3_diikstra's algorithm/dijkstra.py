...
def dijkstra(graph, start_node, end_node):
    ...
    # Build a dictionary that will store the "shortest" distance to all nodes,
    # wrt (with reference to) the start_node
    shortest_distance = {}
...
if __name__ == '__main__':
    ...
    print('Shortest Distance from {} to {} is {}'.format(node_A.value, node_C.value,
                                                         dijkstra(graph, node_A, node_C)))
